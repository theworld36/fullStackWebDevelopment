...
7. Press option + b to start the program and notice the differences. This is just a basic implementation to help understand the structure of CSS as it will be fleshed out in the future.
